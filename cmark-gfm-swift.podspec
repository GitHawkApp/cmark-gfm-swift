...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Ryan Nystrom/cmark-gfm-swift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ryan Nystrom' => 'rnystrom@instagram.com' }
  s.source           = { :git => 'https://github.com/Ryan Nystrom/cmark-gfm-swift.git', :tag => s.version.to_s }
